...
class _Delete_AccountState extends State<Delete_Account> {
  ...
  Widget build(BuildContext context) {
    return Consumer<ProviderDeleteUserAccount>(
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    RadioListTile(
                      ...
                      groupValue: provider.isOnTap,
                      onChanged: (value) {
                        provider.isOnTap = value as String;
                        setState(() {});
                      },
                    ),
                    RadioListTile(
                    ...
                    TextField(
                      controller: provider.deleteController,
                      maxLines: 5,
                    ...
                    InkWell(
                      onTap: () {
                        if (provider.isOnTap == null) {
                          AppMassage.buildShowSnackBar(
                              context, 'Please select your reason');
                        } else if (provider.isOnTap == 'Other' &&
                            provider.deleteController.text.trim().isEmpty) {
                          AppMassage.buildShowSnackBar(
