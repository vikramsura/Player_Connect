  ...
  Widget build(BuildContext context) {
    return Consumer<ProviderPlayerView>(
      builder: (context, provider, child) {
        return SafeArea(
            child: Scaffold(
          body: provider.playerViewList.isEmpty
                        ...
                        Container(
                            ...
                            child: Image(
                                ...
                                image: NetworkImage(ApiUtils.imageApi +
                                    provider.playerViewList[0].images
                                        .toString()))),
                      ],
                    ),
                            ...
                            child: Column(
                                ...
                                children: [
                                  Row(
                                    children: [
                                      Text(
                                        provider.playerViewList[0].rating
                                            .toString(),
                                        style: TextStyle(
                                  ...
                                  Text(
                                    provider.playerViewList[0].firstName
                                        .toString(),
                                    style: TextStyle(
                                  ...
                                  Text2.text2(
                                      "${provider.playerViewList[0].city}, ${provider.playerViewList[0].country?.substring(0, 2).toUpperCase()}"),
                                  SizedBox(
                                    height: AppFontSize.font20,
                                  ),
                                  Row(
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          Text.rich(
                                            ...
                                            TextSpan(
                                                text:
                                                    "(${provider.playerViewList[0].height!.split("(").last}",
                                                style: TextStyle(
                                                    color: AppColor.white1,
                                                    fontSize:
                                                        AppFontSize.font14,
                                  ...
                                  ReadMoreText(
                                    provider.playerViewList[0].about
                                        .toString(),
                                    trimLines: 3,
                                    style: TextStyle(
                                        fontSize: AppFontSize.font16,
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Text1.text1(provider.playerViewList[0]
                                                  .ratingtype ==
                                              0
                                          ? "URT Rating"
                                          : "NTRP Rating"),
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Text2.text2(provider
                                          .playerViewList[0].locationRange
                                          .toString()),
                                    ],
                                  ),
                                  SizedBox(
                                  ...
                                  ReadMoreText(
                                    provider.playerViewList[0].desiredPartner
                                        .toString(),
                                    trimLines: 3,
                                    style: TextStyle(
                                        fontSize: AppFontSize.font16,
