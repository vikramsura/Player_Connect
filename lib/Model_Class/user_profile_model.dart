class UserProfileModel {
  ...
  int? code;
  String? message;
  UserProfileModelBody? body;

  UserProfileModel({this.success, this.code, this.message, this.body});

  UserProfileModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    code = json['code'];
    message = json['message'];
    body = json['body'] != null ? new UserProfileModelBody.fromJson(json['body']) : null;
  }
...
class UserProfileModelBody {
  ...
  UserProfileModelBody.fromJson(Map<String, dynamic> json) {
    id = json['id'];
