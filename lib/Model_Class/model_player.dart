class GetPlayersListModel {
  int? success;
  int? code;
  String? message;
  List<GetPlayersListModelBody>? body;

  GetPlayersListModel({this.success, this.code, this.message, this.body});

  GetPlayersListModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    code = json['code'];
    message = json['message'];
    if (json['body'] != null) {
      body = <GetPlayersListModelBody>[];
      json['body'].forEach((v) {
        body!.add(new GetPlayersListModelBody.fromJson(v));
      });
    }
  }
...
class GetPlayersListModelBody {
 ...
 var deviceType;
  ...
  GetPlayersListModelBody.fromJson(Map<String, dynamic> json) {
    id = json['id'];
